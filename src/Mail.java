...
public class Mail{
 ...
 public String sendEmail(String email) {
        final String username = "MacroCounterTeam@gmail.com";
        final String userpassword = "Macrocounterteam#1";
        String password;
        ...
        try {
            ...
            message.setFrom(new InternetAddress("MacroCounterTeam@gmail.com"));
            message.setRecipients(
                    Message.RecipientType.TO,
                    InternetAddress.parse(email)
            );
            message.setSubject("Password Recovery");
            message.setText("Dear Macro Counter user,"
