 ...
 * @author ryanhoffman
 */
public class NewUser3Controller implements Initializable {
  ...
  //  @FXML private Text passwordInputGuidance;
    ...
    Return: none
    */
    public void backToNewUser2(ActionEvent event)throws IOException{
        Parent newUserParent = FXMLLoader.load(getClass().getResource("NewUser2.fxml"));
    ...
    public void submitClicked(ActionEvent event)throws IOException{
        ...
        if(this.loginIDInputFeedback.getText().length() == 0 && this.passwordInputFeedback.getText().length() ==0){
            ...
            */
            ...
            if(connection.valueExists(this.newUser.getuserName(), "LoginID")){
                ...
                loader.setLocation(getClass().getResource("NewUserConfirmation.fxml"));
